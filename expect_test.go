...
func ExampleVerbose() {
	...
	//
	// testuser@testrouter#
	// [32mSent:[39m "show version\n"
	// [33mMatch for RE:[39m "testrouter# " found: ["testrouter# "] Buffer: Cisco IOS Software, 3600 Software (C3660-I-M), Version 12.3(4)T
	//
	// TAC Support: http://www.cisco.com/tac
	// Copyright (c) 1986-2003 by Cisco Systems, Inc.
	// Compiled Thu 18-Sep-03 15:37 by ccai
	...
	//
	// testrouter#
	// [32mSent:[39m "show system users\n"
	// [33mMatch for RE:[39m "testrouter# " found: ["testrouter# "] Buffer: 7:30PM  up 4 days,  2:26, 2 users, load averages: 0.07, 0.02, 0.01
	// USER     TTY FROM              LOGIN@  IDLE WHAT
	// root     d0  -                Fri05PM 4days -csh (csh)
	// blue   p0 level5.company.net 7:30PM     - cli
	//
